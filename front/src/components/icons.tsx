...
function withDefaults(Icon: IconType, defaultClassName: string) {
  return function WrappedIcon({ className }: IconProps) {
    return <Icon className={[defaultClassName, className].filter(Boolean).join(" ")} />;
  };
}

export const DocumentIcon = withDefaults(FiFileText, "h-4 w-4 text-[#00C0A8]");
export const RequestIcon = withDefaults(FiArrowUpRight, "h-4 w-4 text-[#77818C]");
...
export const AjiltniiCode = withDefaults(HiOutlineIdentification, "h-5 w-5 text-[#00C0A8]");
...
export const CompanyTsalin = withDefaults(LuWalletCards, "h-5 w-5 text-[#00C0A8]");
...
export const AcepptedIcon = withDefaults(AiFillCheckCircle, "h-8 w-8 text-white");
export const RejectedIcon = withDefaults(FiXCircle, "h-8 w-8 text-white");
export const ScrollIcon = withDefaults(BiChevronRight, "h-8 w-8 text-[#99A1AF]");
...
export const SortIcon = withDefaults(BiFilterAlt, "h-[18px] w-[18px] inline ml-1 opacity-60");
export const CheckCircle = withDefaults(FiCheckCircle, "h-7 w-7 text-[#0ad4b1]");
export const PaperclipIcon = withDefaults(FiPaperclip, "h-3.5 w-3.5 text-slate-500");
export const DocRowIcon = withDefaults(FiFileText, "h-3.5 w-3.5 text-slate-500 flex-shrink-0");
export const MailIcon = withDefaults(FiMail, "h-[13px] w-[13px] text-slate-500 flex-shrink-0");
export const BuildingIcon = withDefaults(HiOutlineOfficeBuilding, "h-[13px] w-[13px] text-slate-500 flex-shrink-0");
...
export const ChevronDownn = withDefaults(BiChevronDown, "h-3.5 w-3.5 text-slate-400");
export const ActiveIconn = withDefaults(AiFillCheckCircle, "h-8 w-8 text-white");
...
export const PhoneIcon = withDefaults(FiMail, "h-[13px] w-[13px] text-slate-500 flex-shrink-0");
