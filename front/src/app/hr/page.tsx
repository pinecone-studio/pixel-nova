...
const navItems: NavItem[] = [
  { key: "files", label: "Баримтууд", icon: <FilesIconn /> },
    ...
    <div className="min-h-screen bg-[#060d0c] flex flex-col">
      ...
      <div className="flex flex-1">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 rounded-xl px-2 py-2 transition-all duration-200 text-left w-full
                    ${
                      active
                        ? "bg-[#0ad4b1]/10 text-[#0ad4b1] border border-[#0ad4b1]/25"
        ...
        <main className="flex-1 overflow-y-auto px-6 py-6 flex flex-col gap-5">
          <header className="h-14 border-b border-white/8 flex items-center justify-between px-5 bg-[#060d0c]">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-sm">
              <span className="text-slate-400">HR</span>
              <span className="text-slate-600">›</span>
              <span className="text-white font-bold border-white/20 px-3 py-0.5 rounded-md">
                Баримт бичгүүд
              </span>
            </div>

            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 h-9 px-4 rounded-lg border cursor-pointer border-[#0ad4b1]/50 bg-linear-to-br from-[#0a3b33] to-[#0ad4b1]/50 text-white text-sm font-medium hover:border-[#0ad4b1] transition-colors">
              ...
              <div className="relative">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-11 h-11 rounded-xl bg-[#0ad4b1] flex items-center justify-center shadow-[0_6px_20px_rgba(10,212,177,0.4)]">
                    <span className="text-[#060d0c] text-lg font-bold">✓</span>
                  </div>
                  <button className="text-slate-600 hover:text-slate-400 text-lg">
                    ⋯
                  </button>
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              ...
              >
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center text-base ${s.color}`}
                >
                  {s.icon}
                </div>
                <div>
            ...
            <div className="rounded-2xl border border-[#0ad4b1]/40 bg-[#0a0f0e] overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-dashed border-[#0ad4b1]/30">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="flex items-center gap-2 h-9 px-4 rounded-lg bg-[#085044] text-[#0ad4b1] text-sm font-semibold hover:bg-[#12e6c0] transition-colors">
                    Бүгдийг харах ↗
                  </button>
                </div>
              </div>
